...
ARG NEXT_PUBLIC_ENABLE_TESTDATA
# PROJ-18: Branding-Profil + aktive Formulare je Deployment (Default = FlexCover).
ARG NEXT_PUBLIC_BRAND
ARG NEXT_PUBLIC_ACTIVE_FORMS
ENV NEXT_PUBLIC_SUPABASE_URL=$NEXT_PUBLIC_SUPABASE_URL
ENV NEXT_PUBLIC_SUPABASE_ANON_KEY=$NEXT_PUBLIC_SUPABASE_ANON_KEY
ENV NEXT_PUBLIC_TURNSTILE_SITE_KEY=$NEXT_PUBLIC_TURNSTILE_SITE_KEY
ENV NEXT_PUBLIC_ENABLE_TESTDATA=$NEXT_PUBLIC_ENABLE_TESTDATA
ENV NEXT_PUBLIC_BRAND=$NEXT_PUBLIC_BRAND
ENV NEXT_PUBLIC_ACTIVE_FORMS=$NEXT_PUBLIC_ACTIVE_FORMS
